function X_estimation=pointfeature_AffEKF_v1(X0,P0,z0,U_noise,z_noise,Index,ODOM_noise,OBSV_noise)
...
%     P_adX_W=[A*ODOM_noise*A' A*ODOM_noise*C';C*ODOM_noise'*A' C*ODOM_noise*C'];
    ...
    for j=1:N
        AA(4+3*j:6+3*j,1:3)=skew( X_Prediction(1:3,4+j)-Xn(1:3,4+j) );
    end
    Pn=AA*Pn*AA';
