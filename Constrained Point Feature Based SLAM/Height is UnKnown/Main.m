...
for dataID=1:2
    ...
    for noiseID=1:size(SigmaTable,1)
        ...
        for i=1:m
            ...
            X_Estimation_std=conpointfeature2_StdEKF(X0,P0,z0,U_noise,z_noise,Index,ODOM_noise,OBSV_noise);
            X_Estimation_ideal=conpointfeature2_idealEKF(X0,P0,z0,U_noise,z_noise,Index,ODOM_noise,OBSV_noise,Xstate_gt);
            X_Estimation_ri=pointfeature_RIEKF(X0,P0,z0,U_noise,z_noise,Index,ODOM_noise,OBSV_noise);

            X_Estimation_aff=conpointfeature2_AffEKF(X0,P0,z0,U_noise,z_noise,Index,ODOM_noise,OBSV_noise);
            ...
            %NEES_Std
            NEES_Std_add=conpointfeature2_NEES_Std_add(X_Estimation_std,Xstate_gt,m);
            ...
            %NEES_ideal
            NEES_ideal_add=conpointfeature2_NEES_Std_add(X_Estimation_ideal,Xstate_gt,m);
            ...
            %NEES_Aff
            NEES_Aff_add=conpointfeature2_NEES_Std_add(X_Estimation_aff,Xstate_gt,m);
